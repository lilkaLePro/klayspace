...
export const LogoFigma = (props: ComponentPropsWithoutRef<'svg'> & {size?:number} ) => {
    ...
    return (<>
        ...
        >
            <g>
                ...
                <path d="M256,192 C256,227.328 227.328,256 192,256 C156.672,256 128,227.328 128,192 C128,156.672 156.672,128 192,128 C227.328,128 256,156.672 256,192 Z" fill="currentCurrent"></path>
            </g>
        </svg>
    </>)
}